 ...
 */
public class Rotate270Transformer extends Transformer{

    public Rotate270Transformer(PrimitiveTransformation transformation) {
    ...
    public BufferedImage visualTransform(BufferedImage image) {
        ...
        for(int x=0; x<image.getWidth(); x++){
            for(int y=0; y<image.getHeight(); y++){
                rotatedImage.setRGB(x, y, image.getRGB(image.getHeight() - 1 - y, x));
            }
        }
